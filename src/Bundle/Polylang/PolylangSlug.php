...
final class PolylangSlug implements RegisterHookInterface
{
    ...
    public function polylang_slug_unique_slug_in_language(
        string $slug,
        int $post_ID,
        string $post_status,
        string $post_type,
    ...
    public function polylang_slug_filter_queries(string $query): string
    {
        global $wpdb;
    ...
    public function polylang_slug_posts_where_filter(string $where, WP_Query $query): string
    {
    ...
    public function polylang_slug_posts_join_filter(string $join, WP_Query $query)
    {
        // Check if should contine.
        if (!$this->polylang_slug_should_run($query)) {
            return $join;
    ...
    public function polylang_slug_should_run($query = ''): bool
    {
    ...
    public function polylang_slug_standardize_query(string $query): string
    {
    ...
    public function polylang_slug_model_post_join_clause(): string
    {
    ...
    public function polylang_slug_model_post_where_clause(string $lang = ''): string
    {
        if (function_exists('PLL')) {
